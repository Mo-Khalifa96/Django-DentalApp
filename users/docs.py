...
permissions_field_schema = extend_schema_field({
    'type': 'object', 'properties': {
        ...
        'view.patientInsurance': {'type': 'boolean'},
        'update.patientInsurance': {'type': 'boolean'},
        ...
        'create.insuranceProvider': {'type': 'boolean'},
        'update.insuranceProvider': {'type': 'boolean'},
        'delete.insuranceProvider': {'type': 'boolean'},
            ...
            value={
                ...
                'data': {
                    ...
                    'permissions': {
                        ...
                        'create.insuranceProvider': False,
                        'update.insuranceProvider': False,
                        'delete.insuranceProvider': False,
