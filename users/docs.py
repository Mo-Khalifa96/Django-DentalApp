...
permissions_field_schema = extend_schema_field({
    'type': 'object', 'properties': {
        ...
        # "view.doctorScheduleDetial": {'type': 'boolean'},
        # "create.doctorSchedule": {'type': 'boolean'},
        # "update.doctorSchedule": {'type': 'boolean'},
        # "delete.doctorSchedule": {'type': 'boolean'},
...
retrieve_user_schema = extend_schema_serializer(
    examples=[
            ...
            value={
                ...
                'data': {
                    ...
                    'permissions': {
                        ...
                        # "view.doctorScheduleDetial": True,
                        # "create.doctorSchedule": False,
                        # "update.doctorSchedule": False,
                        # "delete.doctorSchedule": False,
                        "view.labs": True,
                        "create.lab": False,
                        "update.lab": False,
                        "delete.lab": False,
        ...
        OpenApiExample(
            ...
            response_only=True,
            description='Response without user permissions (admin only).',
            value={
                'success': True,
                'data': {
                    'id': '3fa85f64-5717-4562-b3fc-2c963f66afa6',
